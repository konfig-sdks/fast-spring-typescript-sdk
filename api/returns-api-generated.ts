...
export const ReturnsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createNewReturn: async (body: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('createNewReturn', 'body', body)
...
export const ReturnsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         * @summary Create returns
         * @param {ReturnsApiCreateNewReturnRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewReturn(requestParameters: ReturnsApiCreateNewReturnRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const body: any = requestParameters;
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewReturn(body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         * @summary Get returns
         * @param {ReturnsApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: ReturnsApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
...
export const ReturnsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNewReturn(requestParameters: ReturnsApiCreateNewReturnRequest, options?: AxiosRequestConfig): AxiosPromise<any> {
            return localVarFp.createNewReturn(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get returns
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: ReturnsApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<any> {
...
/**
 * Request parameters for createNewReturn operation in ReturnsApi.
 * @export
 * @interface ReturnsApiCreateNewReturnRequest
 */
export type ReturnsApiCreateNewReturnRequest = any

/**
 * Request parameters for getById operation in ReturnsApi.
 * @export
 * @interface ReturnsApiGetByIdRequest
 */
export type ReturnsApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ReturnsApiGetById
    */
    readonly id: string
...
/**
 * ReturnsApiGenerated - object-oriented interface
 * @export
 * @class ReturnsApiGenerated
 * @extends {BaseAPI}
 */
export class ReturnsApiGenerated extends BaseAPI {
    /**
     * 
     * @summary Create returns
     * @param {ReturnsApiCreateNewReturnRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ReturnsApiGenerated
     */
    public createNewReturn(requestParameters: ReturnsApiCreateNewReturnRequest, options?: AxiosRequestConfig) {
        return ReturnsApiFp(this.configuration).createNewReturn(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ReturnsApiGenerated
     */
    public getById(requestParameters: ReturnsApiGetByIdRequest, options?: AxiosRequestConfig) {
        return ReturnsApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
