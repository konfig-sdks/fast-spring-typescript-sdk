...
// @ts-ignore
import { WebhooksUpdateWebhookKeySecret400Response } from '../models';
// @ts-ignore
import { WebhooksUpdateWebhookKeySecretRequest } from '../models';
// @ts-ignore
import { WebhooksUpdateWebhookKeySecretResponse } from '../models';
...
export const WebhooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {WebhooksUpdateWebhookKeySecretRequest} webhooksUpdateWebhookKeySecretRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateWebhookKeySecret: async (webhooksUpdateWebhookKeySecretRequest: WebhooksUpdateWebhookKeySecretRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webhooksUpdateWebhookKeySecretRequest' is not null or undefined
            assertParamExists('updateWebhookKeySecret', 'webhooksUpdateWebhookKeySecretRequest', webhooksUpdateWebhookKeySecretRequest)
            const localVarPath = `/webhooks/keys`;
            ...
            requestBeforeHook({
                requestBody: webhooksUpdateWebhookKeySecretRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/webhooks/keys',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(webhooksUpdateWebhookKeySecretRequest, localVarRequestOptions, configuration)
...
export const WebhooksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         * @summary Update a webhook key secret
         * @param {WebhooksApiUpdateWebhookKeySecretRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateWebhookKeySecret(requestParameters: WebhooksApiUpdateWebhookKeySecretRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhooksUpdateWebhookKeySecretResponse>> {
            const webhooksUpdateWebhookKeySecretRequest: WebhooksUpdateWebhookKeySecretRequest = {
                url: requestParameters.url,
                hmacSecret: requestParameters.hmacSecret
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateWebhookKeySecret(webhooksUpdateWebhookKeySecretRequest, options);
...
export const WebhooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateWebhookKeySecret(requestParameters: WebhooksApiUpdateWebhookKeySecretRequest, options?: AxiosRequestConfig): AxiosPromise<WebhooksUpdateWebhookKeySecretResponse> {
            return localVarFp.updateWebhookKeySecret(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for updateWebhookKeySecret operation in WebhooksApi.
 * @export
 * @interface WebhooksApiUpdateWebhookKeySecretRequest
 */
export type WebhooksApiUpdateWebhookKeySecretRequest = {
...
export class WebhooksApiGenerated extends BaseAPI {
     ...
     */
    public updateWebhookKeySecret(requestParameters: WebhooksApiUpdateWebhookKeySecretRequest, options?: AxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).updateWebhookKeySecret(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
