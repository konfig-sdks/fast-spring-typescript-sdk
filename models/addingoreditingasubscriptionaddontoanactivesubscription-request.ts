 ...
 * 
 * @export
 * @interface AddingoreditingasubscriptionaddontoanactivesubscriptionRequest
 */
export interface AddingoreditingasubscriptionaddontoanactivesubscriptionRequest {
    /**
     * 
     * @type {Array<Subscription3>}
     * @memberof AddingoreditingasubscriptionaddontoanactivesubscriptionRequest
     */
