...
import { Subscription5 } from './subscription5';

/**
 * 
 * @export
 * @interface ChangeasubscriptionfromautomaticrenewaltomanualRequest
 */
export interface ChangeasubscriptionfromautomaticrenewaltomanualRequest {
    /**
     * 
     * @type {Array<Subscription5>}
     * @memberof ChangeasubscriptionfromautomaticrenewaltomanualRequest
     */
