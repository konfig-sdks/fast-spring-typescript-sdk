 ...
 * 
 * @export
 * @interface ChangethedateQuantityorcouponforanactivesubscriptionRequest
 */
export interface ChangethedateQuantityorcouponforanactivesubscriptionRequest {
    /**
     * 
     * @type {Array<Subscription1>}
     * @memberof ChangethedateQuantityorcouponforanactivesubscriptionRequest
     */
