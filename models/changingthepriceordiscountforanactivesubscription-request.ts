 ...
 * 
 * @export
 * @interface ChangingthepriceordiscountforanactivesubscriptionRequest
 */
export interface ChangingthepriceordiscountforanactivesubscriptionRequest {
    /**
     * 
     * @type {Array<Subscription2>}
     * @memberof ChangingthepriceordiscountforanactivesubscriptionRequest
     */
