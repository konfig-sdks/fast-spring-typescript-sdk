 ...
 * 
 * @export
 * @interface CreateasessionapplyingacoupontoanorderRequest
 */
export interface CreateasessionapplyingacoupontoanorderRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateasessionapplyingacoupontoanorderRequest
     */
    'account': string;
    /**
     * 
