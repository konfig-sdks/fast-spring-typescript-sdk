 ...
 * 
 * @export
 * @interface CreateasessionoverridingaproductsdefaultpricingRequest
 */
export interface CreateasessionoverridingaproductsdefaultpricingRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateasessionoverridingaproductsdefaultpricingRequest
     */
    'account': string;
    /**
     * 
