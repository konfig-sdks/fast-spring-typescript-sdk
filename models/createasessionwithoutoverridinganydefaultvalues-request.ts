 ...
 * 
 * @export
 * @interface CreateasessionwithoutoverridinganydefaultvaluesRequest
 */
export interface CreateasessionwithoutoverridinganydefaultvaluesRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateasessionwithoutoverridinganydefaultvaluesRequest
     */
    'account': string;
    /**
     * 
