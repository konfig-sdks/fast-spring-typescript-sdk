...
import { SubscriptionAddon } from './subscription-addon';

/**
 * 
 * @export
 * @interface EstimateSubscriptionRequest
 */
export interface EstimateSubscriptionRequest {
    /**
     * 
     * @type {string}
     * @memberof EstimateSubscriptionRequest
     */
    'subscription': string;
    /**
     * 
