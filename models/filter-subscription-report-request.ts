 ...
 * 
 * @export
 * @interface FilterSubscriptionReportRequest
 */
export interface FilterSubscriptionReportRequest {
    /**
     * 
     * @type {string}
     * @memberof FilterSubscriptionReportRequest
     */
    'startDate'?: string;
    /**
     * 
