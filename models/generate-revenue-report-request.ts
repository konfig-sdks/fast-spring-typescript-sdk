...
import { FilterRevenueReportRequest } from './filter-revenue-report-request';

/**
 * 
 * @export
 * @interface GenerateRevenueReportRequest
 */
export interface GenerateRevenueReportRequest {
    /**
     * 
     * @type {FilterRevenueReportRequest}
     * @memberof GenerateRevenueReportRequest
     */
