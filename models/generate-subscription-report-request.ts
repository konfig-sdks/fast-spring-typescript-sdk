...
import { FilterSubscriptionReportRequest } from './filter-subscription-report-request';

/**
 * 
 * @export
 * @interface GenerateSubscriptionReportRequest
 */
export interface GenerateSubscriptionReportRequest {
    /**
     * 
     * @type {FilterSubscriptionReportRequest}
     * @memberof GenerateSubscriptionReportRequest
     */
