 ...
 * 
 * @export
 * @interface ItemRenewalResponse
 */
export interface ItemRenewalResponse {
    /**
     * 
     * @type {string}
     * @memberof ItemRenewalResponse
     */
    'renewIntoProductId'?: string;
    /**
     * 
     * @type {string}
     * @memberof ItemRenewalResponse
     */
    'renewIntoPath'?: string;
    /**
     * 
     * @type {number}
     * @memberof ItemRenewalResponse
     */
    'renewIntoPrice'?: number;
    /**
     * 
     * @type {string}
     * @memberof ItemRenewalResponse
     */
    'renewIntoPeriod'?: string;
    /**
     * 
     * @type {number}
     * @memberof ItemRenewalResponse
     */
    'renewIntoLevel'?: number;
    /**
     * 
     * @type {string}
     * @memberof ItemRenewalResponse
     */
    'renewIntoIntervalCount'?: string;
    /**
     * 
     * @type {string}
     * @memberof ItemRenewalResponse
     */
    'renewIntoUpcomingProduct'?: string;
}
