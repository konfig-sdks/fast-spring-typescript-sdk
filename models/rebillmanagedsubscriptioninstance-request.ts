...
import { Subscription7 } from './subscription7';

/**
 * 
 * @export
 * @interface RebillmanagedsubscriptioninstanceRequest
 */
export interface RebillmanagedsubscriptioninstanceRequest {
    /**
     * 
     * @type {Array<Subscription7>}
     * @memberof RebillmanagedsubscriptioninstanceRequest
     */
    'subscriptions': Array<Subscription7>;
}
