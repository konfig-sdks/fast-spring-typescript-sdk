 ...
 * 
 * @export
 * @interface RemoveasubscriptionaddonfromanactivesubscriptionRequest
 */
export interface RemoveasubscriptionaddonfromanactivesubscriptionRequest {
    /**
     * 
     * @type {Array<Subscription4>}
     * @memberof RemoveasubscriptionaddonfromanactivesubscriptionRequest
     */
