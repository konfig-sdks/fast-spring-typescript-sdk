...
export interface StatusHistoryResponse {
     ...
     * 
     * @type {string}
     * @memberof StatusHistoryResponse
     */
    'statusUpdatedTo'?: StatusHistoryResponseStatusUpdatedToEnum;
    /**
     * 
     * @type {string}
     * @memberof StatusHistoryResponse
     */
    'statusUpdatedByFullName'?: string;
    /**
     * 
     * @type {string}
     * @memberof StatusHistoryResponse
...
type StatusHistoryResponseStatusUpdatedToEnum = 'OPEN' | 'CANCELED' | 'AWAITING_PAYMENT' | 'COMPLETED' | 'EXPIRED'
