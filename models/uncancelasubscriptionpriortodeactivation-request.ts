...
import { Subscription6 } from './subscription6';

/**
 * 
 * @export
 * @interface UncancelasubscriptionpriortodeactivationRequest
 */
export interface UncancelasubscriptionpriortodeactivationRequest {
    /**
     * 
     * @type {Array<Subscription6>}
     * @memberof UncancelasubscriptionpriortodeactivationRequest
     */
