 ...
 * 
 * @export
 * @interface UpdateoneormoreexistingproductsRequest
 */
export interface UpdateoneormoreexistingproductsRequest {
    /**
     * 
     * @type {Array<Product>}
     * @memberof UpdateoneormoreexistingproductsRequest
     */
