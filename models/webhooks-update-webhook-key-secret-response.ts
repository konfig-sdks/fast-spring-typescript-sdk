 ...
 * 
 * @export
 * @interface WebhooksUpdateWebhookKeySecretResponse
 */
export interface WebhooksUpdateWebhookKeySecretResponse {
    /**
     * 
     * @type {string}
     * @memberof WebhooksUpdateWebhookKeySecretResponse
     */
    'url'?: string;
    /**
     * 
