...
import { WebhooksUpdateWebhookKeySecret400ResponseErrorHmacSecret } from './webhooks-update-webhook-key-secret400-response-error-hmac-secret';

/**
 * 
 * @export
 * @interface WebhooksUpdateWebhookKeySecret400ResponseError
 */
export interface WebhooksUpdateWebhookKeySecret400ResponseError {
    /**
     * 
     * @type {string}
     * @memberof WebhooksUpdateWebhookKeySecret400ResponseError
     */
    'url'?: string;
    /**
     * 
     * @type {WebhooksUpdateWebhookKeySecret400ResponseErrorHmacSecret}
     * @memberof WebhooksUpdateWebhookKeySecret400ResponseError
     */
    'hmacSecret'?: WebhooksUpdateWebhookKeySecret400ResponseErrorHmacSecret;
}
